  ...
  return (
    <div className='packages'>
        <Grid container direction="row" justifyContent="center" >
          ...
          {packages?.length <3 && location.pathname.includes('package') && <Grid key={id} item xs={4}><AddButton buttonType={"addPackage"}/></Grid>}

          {packages?.map((aPackage)=>(

            <Grid key={aPackage.packageId} item xs={4}><Package aPackage={aPackage}/></Grid>
