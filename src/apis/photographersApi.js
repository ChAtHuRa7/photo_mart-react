...
const API = axio.create({baseURL:"http://localhost:8080/photographer-service/api/v1/photographers/"});
...
export const fetchPhotogrphersLimited = (count) => API.get(`?count=${count}`);
